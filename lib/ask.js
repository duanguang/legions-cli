...
exports.boilerplateDetailChoice = {
    ...
    'boilerplate-template-react':[{
        name:`create ${chalk.green('React PC typescript Client Template,the webpack4.x and react15.x')} module boilerplate`,
        value:'template-react-typescript-client-webpack4-react15',
        sourceDir: 'https://github.com:duanguang/react-scaffold-typescript#webpack4-react15-ts'
    },{
        name:`create ${chalk.green('React PC typescript Client Template,the webpack2.x and react15.x')} module boilerplate`,
        value:'template-react-typescript-client-webpack2-react15',
        sourceDir: 'https://github.com:duanguang/react-scaffold-typescript#webpack2-react15-ts'
    },{
        name:`create ${chalk.green('React PC typescript Client Template，the webpack4.x and react16.x')} module boilerplate`,
        value:'template-react-typescript-client-webpack4-react16',
        sourceDir: 'https://github.com:duanguang/react-scaffold-typescript#webpack4-react16-ts'
    },{
        name:`create ${chalk.green('React PC Client Template,the webpack4.x and react15.x')} module boilerplate`,
        value:'template-react-pc-client-webpack2-react15',
        sourceDir: 'https://github.com:duanguang/react-scaffold-typescript#webpack4-react15-JS'
    },{
        name:`create ${chalk.green('React PC Client Template,the webpack2.x and react15.x')} module boilerplate`,
        value:'template-react-pc-client-webpack2-react15',
        sourceDir: 'https://github.com:duanguang/react-scaffold-typescript#webpack2-react15-JS'
    },{
        name: `create ${chalk.green('React mobile Client Template,the webpack4.x and react16.x')} module boilerplate`,
        value: 'template-react-typescript-mobile-client-webpack4-react16-mobile-ts',
        sourceDir: 'https://github.com:duanguang/react-scaffold-typescript#webpack4-react15-mobile-ts'
    },{
        name: `create ${chalk.green('React mobile Client Template,the webpack2.x and react15.x')} module boilerplate`,
        value: 'template-react-typescript-mobile-client-webpack2-react15-mobile-ts',
        sourceDir: 'https://github.com:duanguang/react-scaffold-typescript#webpack2-react15-mobile-ts'
    },],
}
